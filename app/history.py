...
def render():
    ...
    if "history_data" not in st.session_state:
        ...
        load_history = st.button("Load History", type="primary", key="hist_load")
    else:
        load_history = st.button("Refresh History", type="secondary", key="hist_refresh")
    ...
    table_rows = []
    for label, d in sorted(valid_quarters.items()):
        table_rows.append({
            "Quarter": label,
